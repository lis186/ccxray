...
const LITELLM_LAG_OVERRIDES = Object.freeze([
  Object.freeze({
    id: 'grok-4.5',
    // Wire IDs (Grok CLI sends bare names, not xai/…)
    wireIds: Object.freeze(['grok-4.5', 'grok-4.5-latest']),
    // Keys we expect LiteLLM to grow; presence of any retires this override.
    litellmKeys: Object.freeze(['xai/grok-4.5', 'grok-4.5', 'xai/grok-4.5-latest']),
    rates: Object.freeze({ input: 2.00, output: 6.00, cache_create: 0, cache_read: 0.50 }),
    source: 'https://docs.x.ai/developers/models/grok-4.5',
    since: '2026-07-09',
    removeWhen: 'LiteLLM model_prices_and_context_window.json lists xai/grok-4.5',
  }),
  Object.freeze({
    id: 'grok-build',
  ...
  // grok-4.3 already exists as xai/grok-4.3 in LiteLLM; kept only if bare-alias
  // mirroring fails. Prefer auto-retire once bare or xai/ key is in the table.
  Object.freeze({
    id: 'grok-4.3',
    wireIds: Object.freeze(['grok-4.3', 'grok-4.3-latest']),
    litellmKeys: Object.freeze(['xai/grok-4.3', 'xai/grok-4.3-latest', 'grok-4.3', 'grok-4.3-latest']),
    rates: Object.freeze({ input: 1.25, output: 2.50, cache_create: 0, cache_read: 0.20 }),
    source: 'https://docs.x.ai/developers/pricing',
    since: '2026-07-09',
    removeWhen: 'LiteLLM lists xai/grok-4.3 (already does — bare mirror should retire this)',
  }),
]);

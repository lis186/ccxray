...
const HEALTH_CAPABILITIES = Object.freeze(['task-attribution', 'session-intervals', 'cost-charges']);
  ...
  switch (occ && occ.kind) {
    case 'ccxray-standalone':
      ...
      return [
        ...
        `This process records into ${resolveLogsDir()}. To record separately, set CCXRAY_HOME=<dir>.`,
      ];
    case 'ccxray-hub':

...
| `server/task-summary.js` | Pure aggregator behind `GET /_api/task-summary` (per task, optional role/project filter, `by_role` breakdown). Sums the canonical disjoint usage fields; never trusts a provider `total_tokens` |

...
`--json` 出力はエージェント向けの契約です — フィールドごとの完全なスキーマ、multi-cwd とエラー時の出力形状、フィルタのセマンティクスは [`docs/usage.md`](https://raw.githubusercontent.com/lis186/ccxray/v2.1.0/docs/usage.md) を参照してください。

...
- **Dashboard navigation dead-ends.** Cold sessions promote to hot when live data arrives (#330); collapsed sidebars recover instead of stranding you on a blank view (#358); the empty Turns column hides until a session is selected (#324).
